...
#ifndef INCLUDE_G35_PROGRAMS_LEDStrip_RANDOM_STROBE_H
#define INCLUDE_G35_PROGRAMS_LEDStrip_RANDOM_STROBE_H

#include <LEDStripLightProgram.h>

class LEDStripRandomStrobe : public LEDStripLightProgram
{
public:
    LEDStripRandomStrobe(LEDStripG35& g35, uint8_t pattern);
    uint32_t Do();
