...
#ifndef INCLUDE_G35_PROGRAMS_LEDStrip_RAINBOW_H
#define INCLUDE_G35_PROGRAMS_LEDStrip_RAINBOW_H

#include <LEDStripLightProgram.h>

class LEDStripRainbow : public LEDStripLightProgram
{
public:
    LEDStripRainbow(LEDStripG35& g35, uint8_t pattern);
    uint32_t Do();
